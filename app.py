...
# IMPORTANT: regenerate your old key at console.groq.com, then set this as
# an Environment Variable named GROQ_API_KEY on your hosting platform
# (Render -> Environment tab). Never hardcode the key in the code.
client = Groq(
